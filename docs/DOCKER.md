...
> ⚠️ **ВАЖНО**: В Docker-режиме **НЕ работают** AI-ассистент и голосовые сообщения по умолчанию.
> 
> **Бот полностью функционален** через кнопочное меню:
> - ✅ Все сборки генерируются через AI (мета, случайные, по лояльности, по бюджету)
> - ✅ Поиск оружия, квесты, тир-листы
> - ✅ Полная локализация RU/EN
> 
> Для текстового AI-ассистента и голосовых сообщений используйте `poetry run python start.py`
