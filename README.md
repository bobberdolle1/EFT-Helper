...
### 🤖 AI-ассистент «Никита Буянов» (НОВОЕ v5.1)
...
- **Умная генерация**: Учитывает актуальные данные, бюджет, уровни торговцев
- **Голосовой ввод**: Поддержка голосовых сообщений через Whisper
...
- **FFmpeg:** Для голосового ввода (Whisper)
...
# 2. (Опционально) Если используете AI - запустите локальный Ollama
ollama serve
...
> 💡 **Примечание**: По умолчанию используется локально установленный Ollama. Docker контейнер Ollama закомментирован для экономии ресурсов.
...
- 🤖 [AI-ассистент](docs/AI_ASSISTANT_SETUP.md) - настройка Qwen3-8B и голосового ввода
